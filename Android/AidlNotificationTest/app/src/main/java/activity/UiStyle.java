...
//    private final String TAG = AppInfo.OWNER+"LayoutStyle";
    ...
    public static final int LAYOUT_STYLE_LINE = 100;
    public static final int LAYOUT_STYLE_R = 101;
    public static final int LAYOUT_STYLE_L = 102;
    ...
    public int GetColor(int Rid) {
        return AppInfo.getInstance().getAppResource().getColor(Rid);
    }

    public LinearLayout.LayoutParams newLayoutStyle(int type, int margin) {
    ...
    public TextView newTextViewStyle(int style, int layout_style, int margin) {
        TextView textview = new TextView(AppInfo.getInstance().getApplicationContext());
        textview.setLayoutParams(newLayoutStyle(layout_style, margin));
    ...
    public Button newButtonStyle(int style, int layout_style, int margin) {
        Button button = new Button(AppInfo.getInstance().getApplicationContext());
        button.setLayoutParams(newLayoutStyle(layout_style, margin));
    ...
    public CheckBox newCheckBoxStyle(int style, int layout_style, int margin) {
        CheckBox checkbox = new CheckBox(AppInfo.getInstance().getApplicationContext());
        checkbox.setLayoutParams(newLayoutStyle(layout_style, margin));
    ...
    public Spinner newSpinnerStyle(int style, int layout_style, int margin) {
        Spinner spinner = new Spinner(AppInfo.getInstance().getApplicationContext());
        spinner.setLayoutParams(newLayoutStyle(layout_style, margin));
